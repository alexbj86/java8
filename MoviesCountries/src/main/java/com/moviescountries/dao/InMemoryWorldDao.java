...
public class InMemoryWorldDao implements WorldDao{
    ...
    public void createCities1() {
        ...
        cities.put(40, new City(40, "Sâ??tif", "DZA", 179055));
        ...
        cities.put(45, new City(45, "Bâ??jaâ?¹a", "DZA", 117162));
        cities.put(46, new City(46, "Mostaganem", "DZA", 115212));
        cities.put(47, new City(47, "Tâ??bessa", "DZA", 112007));
        cities.put(48, new City(48, "Tlemcen (Tilimsen)", "DZA", 110242));
        cities.put(49, new City(49, "Bâ??char", "DZA", 107311));
        ...
        cities.put(84, new City(84, "Santa Fâ??", "ARG", 353063));
        ...
        cities.put(99, new City(99, "Josâ?? C. Paz", "ARG", 221754));
        ...
        cities.put(103, new City(103, "Guaymallâ??n", "ARG", 200595));
        ...
        cities.put(107, new City(107, "Neuquâ??n", "ARG", 167296));
        ...
        cities.put(145, new City(145, "Gâ??ncâ??", "AZE", 299300));
        cities.put(146, new City(146, "Sumqayit", "AZE", 283000));
        cities.put(147, new City(147, "Mingâ??â?¡evir", "AZE", 93900));
        ...
        cities.put(216, new City(216, "Belâ??m", "BRA", 1186926));
        ...
        cities.put(230, new City(230, "Santo Andrâ??", "BRA", 630073));
        ...
        cities.put(234, new City(234, "SÃ?o Josâ?? dos Campos", "BRA",
                515553));
        ...
        cities.put(254, new City(254, "SÃ?o Josâ?? do Rio Preto", "BRA",
                351944));
        ...
        cities.put(282, new City(282, "Ilhâ??us", "BRA", 254970));
        ...
        cities.put(289, new City(289, "Santarâ??m", "BRA", 241771));
        ...
        cities.put(298, new City(298, "Taubatâ??", "BRA", 229130));
        ...
        cities.put(311, new City(311, "SÃ?o Josâ?? dos Pinhais", "BRA",
                196884));
        cities.put(312, new City(312, "Magâ??", "BRA", 196147));
        ...
        cities.put(317, new City(317, "Sumarâ??", "BRA", 186205));
        ...
        cities.put(323, new City(323, "Jequiâ??", "BRA", 179128));
        ...
        cities.put(346, new City(346, "SÃ?o Josâ??", "BRA", 155105));
        ...
        cities.put(382, new City(382, "Bagâ??", "BRA", 120793));
        ...
        cities.put(426, new City(426, "SÃ?o Josâ?? de Ribamar", "BRA",
                98318));
        ...
        cities.put(577, new City(577, "Quilpuâ??", "CHL", 118857));
        ...
        cities.put(584, new City(584, "San Josâ??", "CRI", 339131));
        ...
        cities.put(683, new City(683, "Leganâ??s", "ESP", 173163));
        ...
        cities.put(702, new City(702, "Lleida (Lâ??rida)", "ESP", 112207));
        cities.put(703, new City(703, "Jaâ??n", "ESP", 109247));
        ...
        cities.put(787,
                new City(787, "San Josâ?? del Monte", "PHL", 315807));
    ...
    public void createCities1000() {
        ...
        cities.put(1804, new City(1804, "Yaoundâ??", "CMR", 1372800));
        ...
        cities.put(1810, new City(1810, "Montrâ??al", "CAN", 1016376));
        ...
        cities.put(1832, new City(1832, "Quâ??bec", "CAN", 167264));
    ...
    public void createCities2000() {
        ...
        cities.put(2257, new City(2257, "Santafâ?? de BogotÂ ", "COL",
                6260862));
        ...
        cities.put(2264, new City(2264, "Ibaguâ??", "COL", 393664));
        ...
        cities.put(2457, new City(2457, "Antsirabâ??", "MDG", 120239));
        ...
        cities.put(2490, new City(2490, "Salâ??", "MAR", 504420));
        cities.put(2491, new City(2491, "MeknÅ s", "MAR", 460000));
        cities.put(2492, new City(2492, "Oujda", "MAR", 365382));
        cities.put(2493, new City(2493, "Kâ??nitra", "MAR", 292600));
        cities.put(2494, new City(2494, "Tâ??touan", "MAR", 277516));
    ...
    public void createCities2500() {
        cities.put(2500, new City(2500, "Tâ??mara", "MAR", 126303));
        ...
        cities.put(2515, new City(2515, "Ciudad de Mâ??xico", "MEX",
                8591309));
        ...
        cities.put(2530, new City(2530, "Mâ??rida", "MEX", 703324));
        ...
        cities.put(2536, new City(2536, "Querâ??taro", "MEX", 639839));
        ...
        cities.put(2550,
                new City(2550, "Tuxtla Gutiâ??rrez", "MEX", 433544));
        ...
        cities.put(2616, new City(2616, "San Luis RÂ¡o Colorado", "MEX",
                145276));
        cities.put(2617, new City(2617, "Pâ??njamo", "MEX", 143927));
        cities.put(2618, new City(2618, "San Andrâ??s Tuxtla", "MEX",
                142251));
        ...
        cities.put(2636, new City(2636, "San Pedro Garza GarcÂ¡a", "MEX",
                126147));
        cities.put(2637, new City(2637, "Cuauhtâ??moc", "MEX", 124279));
        ...
        cities.put(2676, new City(2676, "Josâ?? Azueta", "MEX", 95448));
        ...
        cities.put(2813, new City(2813, "Bouakâ??", "CIV", 329850));
        ...
        cities.put(2888, new City(2888, "Lambarâ??", "PRY", 99681));
    ...
    public void createCities3000() {
        ...
        cities.put(3004, new City(3004, "Orlâ??ans", "FRA", 113126));
        ...
        cities.put(3053, new City(3053, "Vâ??sterâ? s", "SWE", 126328));
        ...
        cities.put(3062, new City(3062, "Gâ??vle", "SWE", 90742));
        ...
        cities.put(3172, new City(3172, "SÃ?o Tomâ??", "STP", 49541));
        ...
        cities.put(3332, new City(3332, "Lomâ??", "TGO", 375000));
        ...
        cities.put(3337, new City(3337, "NÃ¯Djamâ??na", "TCD", 530965));
        ...
        cities.put(3345, new City(3345, "Ceskâ?? Budejovice", "CZE", 98186));
        cities.put(3346,
                new City(3346, "Hradec KrÂ lovâ??", "CZE", 98080));
        ...
        cities.put(3420, new City(3420, "Châ??rjew", "TKM", 189200));
        ...
        cities.put(3487, new City(3487, "Pâ??cs", "HUN", 157332));
        cities.put(3488, new City(3488, "Gyâ??r", "HUN", 127119));
        cities.put(3489, new City(3489, "NyiregyhÂ za", "HUN", 112419));
        cities.put(3490, new City(3490, "Kecskemâ??t", "HUN", 105606));
        cities.put(3491, new City(3491, "Szâ??kesfehâ??rvÂ r", "HUN",
                105119));
        cities.put(3492, new City(3492, "Montevideo", "URY", 1236000));
        cities.put(3493, new City(3493, "Noumâ??a", "NCL", 76293));
        ...
        cities.put(3551, new City(3551, "Mâ??rida", "VEN", 224887));
    ...
    public void createCountries() {
        ...
        countries.put("CIV", new Country("CIV", "Câ??te d?Ivoire",
        ...
        countries.put("REU", new Country("REU", "Râ??union", "Africa",
